...
Trainer.destroy_all
Trainer.create(name: "Ash", level: rand(99), img_url: "https://upload.wikimedia.org/wikipedia/en/0/09/AshXYanime.png")
Trainer.create(name: "Misty", level: rand(99), img_url: "https://upload.wikimedia.org/wikipedia/en/b/b1/MistyEP.png")
